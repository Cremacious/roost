...
export const PREMIUM_GATE_CONFIG: Record<string, PremiumGateFeatureConfig> = {
  ...
  themes: {
    ...
    perks: [
      "Midnight theme with dark mode and red accents",
      "Forest theme with deep green for a calm focused feel",
      "Slate theme with cool grey for a minimal clean look",
      "Sand theme with warm neutrals that are easy on the eyes",
