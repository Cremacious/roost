...
export const PREMIUM_GATE_CONFIG: Record<string, PremiumGateFeatureConfig> = {
  ...
  allowances: {
    ...
    subtitle: "Set weekly allowances for your kids, tied to chore completion. They earn it, you track it — automatically.",
    perks: [
      "Set a weekly allowance amount per child",
      "Tie payouts to chore completion so kids earn what they do",
      "Adjustable threshold so you decide what counts as a good week",
      "Earned allowances appear in your settle-up flow automatically",
      "Full allowance history per child member",
    ],
    valueProp: VALUE_PROP,
  },
