...
export const PREMIUM_GATE_CONFIG: Record<string, PremiumGateFeatureConfig> = {
  ...
  allowances: {
    ...
    featureDarkHex: '#C93B3B',
    icon: PiggyBank,
    title: "Reward the helpers.",
    subtitle: "Set rewards for your kids tied to chore completion. Money, gifts, activities. They earn it, Roost tracks it.",
    perks: [
      "Flexible reward types: money, gifts, activities, or anything you choose",
      "Weekly, monthly, yearly, or custom periods to fit your family",
      "Adjustable completion threshold so you set the bar",
      "Money rewards are logged as expenses automatically, no manual tracking",
      "Kids see their progress and can claim earned rewards from their dashboard",
    ],
    valueProp: VALUE_PROP,
  },
